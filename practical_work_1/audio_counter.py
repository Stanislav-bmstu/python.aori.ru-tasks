...
#   В нём создать список аудио-записей
#   (каждая запись - это словарь из исполнителя и названия)
...
#   На выходе - словарь, в котором ключ - исполнитель,
#   а значение - количество песен этого исполнителя в списке записей.
...
#   Для этого она должна запускать функцию с разными наборами аудио
#   и проверять, что результат её работы соответствует ожидаемому.
#   Функция должна возвращать True или False в зависимости от того,
# верно работает функция или нет.
